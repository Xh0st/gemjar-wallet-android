...
public class OpenSeaService
{
    ...
    public void resetOffsetRead(List<Long> networkFilter)
    {
        ...
        {
            if (com.gemjarwallet.app.repository.EthereumNetworkBase.hasOpenseaAPI(networkId))
            {
    ...
    {
        if (!com.gemjarwallet.app.repository.EthereumNetworkBase.hasOpenseaAPI(token.tokenInfo.chainId))
        {
            return Single.fromCallable(() -> "");
        }
        else
