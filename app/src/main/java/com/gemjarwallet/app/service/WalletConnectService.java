...
import static com.gemjarwallet.app.C.WALLET_CONNECT_ADD_CHAIN;
import static com.gemjarwallet.app.C.WALLET_CONNECT_CLIENT_TERMINATE;
import static com.gemjarwallet.app.C.WALLET_CONNECT_COUNT_CHANGE;
import static com.gemjarwallet.app.C.WALLET_CONNECT_FAIL;
import static com.gemjarwallet.app.C.WALLET_CONNECT_NEW_SESSION;
import static com.gemjarwallet.app.C.WALLET_CONNECT_REQUEST;
import static com.gemjarwallet.app.C.WALLET_CONNECT_SWITCH_CHAIN;
...
import com.gemjarwallet.app.entity.walletconnect.SignType;
...
public class WalletConnectService extends Service
{
    ...
    //TODO: Can we determine if GemjarWallet is running? If it is, no need to add this to the queue,
