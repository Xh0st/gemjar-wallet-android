...
import com.gemjarwallet.app.viewmodel.AdvancedSettingsViewModel;
...
public class AdvancedSettingsActivity extends BaseActivity
{
        ...
        switch (requestCode)
        {
            case HomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM:
                if (viewModel.createDirectory())
                {
                    ...
                    showGemjarWalletDirectoryConfirmation();
    ...
    private void showGemjarWalletDirectoryConfirmation()
    {
