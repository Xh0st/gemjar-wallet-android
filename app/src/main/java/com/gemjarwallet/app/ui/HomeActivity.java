...
import static com.gemjarwallet.app.C.ADDED_TOKEN;
import static com.gemjarwallet.app.C.CHANGED_LOCALE;
import static com.gemjarwallet.app.C.CHANGE_CURRENCY;
import static com.gemjarwallet.app.C.RESET_TOOLBAR;
import static com.gemjarwallet.app.C.RESET_WALLET;
import static com.gemjarwallet.app.C.SETTINGS_INSTANTIATED;
import static com.gemjarwallet.app.C.SHOW_BACKUP;
import static com.gemjarwallet.app.entity.WalletPage.ACTIVITY;
import static com.gemjarwallet.app.entity.WalletPage.DAPP_BROWSER;
import static com.gemjarwallet.app.entity.WalletPage.SETTINGS;
import static com.gemjarwallet.app.entity.WalletPage.WALLET;
...
import com.gemjarwallet.app.entity.ErrorEnvelope;
import com.gemjarwallet.app.entity.FragmentMessenger;
import com.gemjarwallet.app.entity.HomeCommsInterface;
import com.gemjarwallet.app.entity.HomeReceiver;
import com.gemjarwallet.app.entity.Operation;
import com.gemjarwallet.app.entity.SignAuthenticationCallback;
import com.gemjarwallet.app.entity.Wallet;
import com.gemjarwallet.app.entity.WalletPage;
...
import com.gemjarwallet.app.service.PriceAlertsService;
import com.gemjarwallet.app.ui.widget.entity.PagerCallback;
...
import com.gemjarwallet.app.viewmodel.BaseNavigationActivity;
...
import com.gemjarwallet.app.widget.SignTransactionDialog;
        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, LifecycleObserver, PagerCallback
{
    ...
    {
        Timber.tag("LIFE").d("GemjarWallet into foreground");
        if (viewModel != null)
        {
    ...
    {
        Timber.tag("LIFE").d("GemjarWallet into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setTitle(R.string.gemjarwallet_update);
                cDialog.setCancelable(true);
                cDialog.setSmallText("Using an old version of Gemjarwallet. Please update from the Play Store or GemjarWallet website.");
