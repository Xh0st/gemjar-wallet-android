...
import com.gemjarwallet.app.entity.lifi.Connection;
import com.gemjarwallet.app.entity.lifi.Quote;
import com.gemjarwallet.app.entity.lifi.Token;
import com.gemjarwallet.app.ui.widget.entity.ActionSheetCallback;
import com.gemjarwallet.app.ui.widget.entity.ProgressInfo;
import com.gemjarwallet.app.util.BalanceUtils;
import com.gemjarwallet.app.util.SwapUtils;
import com.gemjarwallet.app.viewmodel.SwapViewModel;
import com.gemjarwallet.app.viewmodel.Tokens;
...
import com.gemjarwallet.app.widget.SelectTokenDialog;
import com.gemjarwallet.app.widget.StandardHeader;
import com.gemjarwallet.app.widget.SwapSettingsDialog;
import com.gemjarwallet.app.widget.TokenInfoView;
import com.gemjarwallet.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.gemjarwallet.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.gemjarwallet.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
