...
public class DappBrowserUtils {
    ...
    private static final String DEFAULT_HOMEPAGE = "https://gemjarwallet.com/browser/";
    private static final String POLYGON_HOMEPAGE = "https://gemjarwallet.com/browser-item-category/polygon/";
