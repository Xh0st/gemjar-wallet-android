...
import static com.gemjarwallet.app.entity.MagicLinkParcel.generateReverseTradeData;
import static com.gemjarwallet.token.tools.ParseMagicLink.currencyLink;
import static com.gemjarwallet.token.tools.ParseMagicLink.customizable;
import static com.gemjarwallet.token.tools.ParseMagicLink.normal;
import static com.gemjarwallet.token.tools.ParseMagicLink.spawnable;
import static com.gemjarwallet.token.tools.ParseMagicLink.unassigned;
...
public class ImportTokenViewModel extends BaseViewModel
{
    ...
    ImportTokenViewModel(GenericWalletInteract genericWalletInteract,
                         ...
                         GemjarWalletService gemjarWalletService,
        ...
        this.gemjarWalletService = gemjarWalletService;
    ...
    public void importThroughFeemaster(String url)
    {
        try
        {
            initParser();
            MagicLinkData order = parser.parseUniversalLink(universalImportLink);
            disposable = gemjarWalletService.handleFeemasterImport(url, wallet.getValue(), network.getValue().chainId, order)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
    ...
    {
        disposable = gemjarWalletService.checkFeemasterService(feemasterServer, network.getValue().chainId, importOrder.contractAddress)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
