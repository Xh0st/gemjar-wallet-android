...
public class Web3View extends WebView {
    ...
    private static final String JS_PROTOCOL_ON_SUCCESSFUL = "GemjarWallet.executeCallback(%1$s, null, \"%2$s\")";
    private static final String JS_PROTOCOL_EXPR_ON_SUCCESSFUL = "GemjarWallet.executeCallback(%1$s, null, %2$s)";
    private static final String JS_PROTOCOL_ON_FAILURE = "GemjarWallet.executeCallback(%1$s, \"%2$s\", null)";
