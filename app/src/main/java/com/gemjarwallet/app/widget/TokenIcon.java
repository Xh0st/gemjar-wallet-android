...
public class TokenIcon extends ConstraintLayout
{
    ...
    private void displayTokenIcon(IconItem iconItem)
    {
        ...
        {
            final RequestOptions optionalCircleCrop = squareToken || iconItem.getUrl().startsWith(Utils.GEMJARWALLET_REPO_NAME) ? new RequestOptions() : new RequestOptions().circleCrop();
