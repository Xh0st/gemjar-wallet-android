package com.gemjarwallet.token.web;
...
import com.gemjarwallet.token.entity.MagicLinkInfo;
import com.gemjarwallet.token.entity.NonFungibleToken;
...
import com.gemjarwallet.token.web.Ethereum.TokenscriptFunction;
import com.gemjarwallet.token.web.Ethereum.TransactionHandler;
import com.gemjarwallet.token.web.Service.CryptoFunctions;
import static com.gemjarwallet.token.tools.Convert.getEthString;
import static com.gemjarwallet.token.tools.ParseMagicLink.normal;
import static com.gemjarwallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.gemjar.wallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://gemjarwallet.com");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using GemjarWallet with WalletConnect, please launch the GemjarWallet app";
        }
