...
import com.gemjarwallet.token.util.DateTime;
import com.gemjarwallet.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'GemjarWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
